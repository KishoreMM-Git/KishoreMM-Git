...
namespace Xrm
{
    public class BaseWorkflowActivityContext : IExtendedWorkflowContext
    {
        ...
        /// <summary>
        /// Fullname of the workflow activity the context is running against
        /// </summary>
        public string WorkflowActivityTypeName { get; }

        /// <summary>
        /// Name of the workflow activity the context is running against
        /// </summary>
        public string WorkflowActivityName { get; }
        ...
        public BaseWorkflowActivityContext(CodeActivityContext activityContext, BaseWorkflowActivity workflow)
        {
            ...
            WorkflowActivityTypeName = workflowType.FullName;
            WorkflowActivityName = workflowType.Name;
        }
        ...
        public T GetConfigValue<T>(string configKey, string configSetupName = "")
        {
            ...
            {
                configSetupName = WorkflowActivityName;
            }
