...
namespace Xrm
{
    public abstract class BasePlugin : IBasePlugin
    {
        ...
        /// <param name="events">List of <see href="RegisteredEvents" /> for the plugin</param>D:\Infy_ms\InfyMS\Infy.MS-Phase2\Infy.MS.Plugin\PluginClasses\ContactDuplicateDetectionPostCreate.cs
